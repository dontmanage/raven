...
const LeaveThreadButton = () => {
    ...
    const { call } = useDontManagePostCall('raven.api.raven_channel.leave_channel')
...
const ToggleNotificationButton = ({ channelMember }: { channelMember: Member }) => {
    ...
    const { call } = useDontManagePostCall('raven.api.notification.toggle_push_notification_for_channel')
