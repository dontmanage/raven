        ...
        <Box className="h-[calc(100vh-57px)] fixed w-64 border-r pt-2 border-gray-4 dark:border-gray-4">
            <Flex direction="column" gap='2' className='px-4'>
                ...
                <SettingsGroup title='Integrations' icon={BsBoxes}>
                    {/* <SettingsSidebarItem title="DontManageErp" to='dontmanageerp' /> */}
                    ...
                    {/* <SettingsSidebarItem title="DontManage LMS" to='dontmanage-lms' /> */}
                    {/* <SettingsSidebarItem title="DontManage CRM" to='dontmanage-crm' /> */}
                </SettingsGroup>
                <SettingsSeparator />
