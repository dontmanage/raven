...
export const ViewWebhookPage = ({ data, mutate }: { data: DontManageDoc<RavenWebhook>, mutate: KeyedMutator<DontManageDoc<RavenWebhook>> }) => {
    ...
    const { updateDoc, loading, reset, error } = useDontManageUpdateDoc()
