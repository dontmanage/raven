    ...
    return <Stack gap='4'>
        ...
        <Stack pt='2'>
            ...
            <HelperText size='2'>
                ...
                <br /><br />
                If enabled, an additional header (X-DontManage-Webhook-Signature) will be added to the request before it's sent out, with its value being generated from the secret as a base64-encoded HMAC-SHA256 hash of the payload.
            </HelperText>
