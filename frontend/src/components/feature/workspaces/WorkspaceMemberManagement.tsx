...
import { useDontManageDeleteDoc, useDontManageGetCall, useDontManagePostCall, useDontManageUpdateDoc, useSWRConfig } from "dontmanage-react-sdk"
...
export const useFetchWorkspaceMembers = (workspaceID: string) => {
    return useDontManageGetCall<{ message: WorkspaceMemberFields[] }>('raven.api.workspaces.fetch_workspace_members', { workspace: workspaceID }, ["workspace_members", workspaceID], {
...
const RemoveMemberButton = ({ memberID, onUpdate }: { memberID: string, onUpdate: () => void }) => {
    ...
    const { deleteDoc } = useDontManageDeleteDoc()
...
const MakeAdminButton = ({ memberID, onUpdate }: { memberID: string, onUpdate: () => void }) => {
    ...
    const { updateDoc } = useDontManageUpdateDoc()
...
const ManageMembersDialogContent = ({ workspaceID, onClose, members }: { workspaceID: string, onClose: () => void, members: WorkspaceMemberFields[] }) => {
    ...
    const { call, loading, error } = useDontManagePostCall('raven.api.workspaces.update_workspace_members')
