...
import { useDontManageGetCall, useDontManageGetDocList } from 'dontmanage-react-sdk'
...
const InstructionPreview = () => {
    ...
    const { data } = useDontManageGetCall('raven.api.ai_features.get_instruction_preview', {
        instruction
    })
...
const ImportTemplate = () => {
    ...
    const { data, error } = useDontManageGetDocList<RavenBotInstructionTemplate>("Raven Bot Instruction Template", {
