...
import { DontManageConfig, DontManageContext, useDontManageGetCall, useSearch } from "dontmanage-react-sdk"
...
const OptionsAutoFill = ({ doctype, fieldname }: { doctype: string, fieldname: string }) => {
    ...
    const { data } = useDontManageGetCall<{ message: number }>('dontmanage.desk.reportview.get_count', {
