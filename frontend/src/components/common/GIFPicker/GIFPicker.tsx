...
// @ts-expect-error
export const TENOR_API_KEY = window.dontmanage?.boot.tenor_api_key
// @ts-expect-error
export const TENOR_CLIENT_KEY = import.meta.env.DEV ? `dev::${window.dontmanage?.boot.sitename}` : window.dontmanage?.boot.sitename
