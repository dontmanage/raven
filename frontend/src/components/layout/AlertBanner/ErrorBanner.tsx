...
export const getErrorMessage = (error?: DontManageError | null): string => {
    const messages = getErrorMessages(error)
    return messages.map(m => m.message).join('\n')
}

const getErrorMessages = (error?: DontManageError | null): ParsedErrorMessage[] => {
    if (!error) return []
