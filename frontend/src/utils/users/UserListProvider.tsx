...
export const UserListProvider = ({ children }: PropsWithChildren) => {
    ...
    const { data, error: usersError, mutate, isLoading } = useDontManageGetCall<{ message: UserFields[] }>('raven.api.raven_users.get_list', undefined, 'raven.api.raven_users.get_list', {
     ...
     */
    useDontManageDocTypeEventListener('Raven User', () => {
