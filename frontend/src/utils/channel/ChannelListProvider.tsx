...
export const useFetchChannelList = (): ChannelListContextType => {
    ...
    const { data, mutate, ...rest } = useDontManageGetCall<{ message: ChannelList }>("raven.api.raven_channel.get_all_channels", {
        hide_archived: false
    }, `channel_list`, {
    ...
    useDontManageDocTypeEventListener('Raven Channel', () => {
        mutate()
