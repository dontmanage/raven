...
import { Filter, useDontManageGetDocList, useDontManagePostCall } from 'dontmanage-react-sdk'
...
const AddRavenUsersCard = () => {
    ...
    const { data, error } = useDontManageGetDocList<User>("User", {
    ...
    const { loading, call, error: postError } = useDontManagePostCall('raven.api.raven_users.add_users_to_raven')
