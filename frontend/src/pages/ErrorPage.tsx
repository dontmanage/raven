    ...
    return (
        <Flex className='h-screen w-screen bg-gray-2' align='center' justify='center'>
            <Stack gap='4'>
                ...
                <Text>If you face this error again, please report it either on <Link target='_blank' href='https://github.com/dontmanage/raven/issues'>GitHub</Link> or <Link target='_blank' href='https://https://support.ravenchat.ai/'> our support portal</Link>.</Text>
