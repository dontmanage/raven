...
import { useDontManageGetDoc, useDontManageUpdateDoc, SWRResponse, DontManageContext, DontManageConfig } from "dontmanage-react-sdk"
...
const ViewBot = (props: Props) => {
    ...
    const { data, isLoading, error, mutate } = useDontManageGetDoc<RavenBot>("Raven Bot", ID)
...
const ViewBotContent = ({ data, mutate }: { data: RavenBot, mutate: SWRResponse['mutate'] }) => {
    ...
    const { updateDoc, loading, error } = useDontManageUpdateDoc<RavenBot>()
