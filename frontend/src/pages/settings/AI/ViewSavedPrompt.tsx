...
const ViewSavedPrompt = (props: Props) => {
    ...
    const { data, isLoading, error, mutate } = useDontManageGetDoc<RavenBotAIPrompt>("Raven Bot AI Prompt", ID)
...
const ViewSavedPromptContent = ({ data, mutate }: { data: RavenBotAIPrompt, mutate: SWRResponse['mutate'] }) => {
    ...
    const { updateDoc, loading, error } = useDontManageUpdateDoc<RavenBotAIPrompt>()
