...
const ViewFunction = (props: Props) => {
    ...
    const { data, isLoading, error, mutate } = useDontManageGetDoc<RavenAIFunction>("Raven AI Function", ID)
...
const ViewFunctionContent = ({ data, mutate }: { data: RavenAIFunction, mutate: SWRResponse['mutate'] }) => {
    ...
    const { updateDoc, loading, error } = useDontManageUpdateDoc<RavenAIFunction>()
