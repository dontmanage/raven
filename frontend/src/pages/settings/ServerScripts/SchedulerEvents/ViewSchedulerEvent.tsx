...
import { useDontManageGetDoc, useDontManageUpdateDoc } from "dontmanage-react-sdk"
...
const ViewSchedulerEvent = () => {
    ...
    const { data: eventData, error, mutate, isLoading } = useDontManageGetDoc<RavenSchedulerEvent>('Raven Scheduler Event', ID)
...
const ViewSchedulerEventPage = ({ data, onUpdate }: { data: RavenSchedulerEvent, onUpdate: () => void }) => {
    ...
    const { updateDoc, error, loading } = useDontManageUpdateDoc()
