...
const SchedulerEvents = () => {
    ...
    const { data, error, isLoading, mutate } = useDontManageGetDocList<RavenSchedulerEvent>('Raven Scheduler Event', {
    ...
    useDontManageDocTypeEventListener('Raven Scheduler Event', () => {
        mutate()
    })
