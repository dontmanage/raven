...
const DontManageHR = () => {
    ...
    const { updateDoc, loading: updatingDoc, error } = useDontManageUpdateDoc<RavenSettings>()

    //@ts-expect-error
    const isHRInstalled = window?.dontmanage?.boot?.versions?.hrms !== undefined
...
export const Component = DontManageHR