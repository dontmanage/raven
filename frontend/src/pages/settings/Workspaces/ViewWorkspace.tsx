...
import { useDontManageGetDoc, useDontManageUpdateDoc, SWRResponse, useSWRConfig } from "dontmanage-react-sdk"
...
const ViewWorkspace = () => {
    ...
    const { data, isLoading, error, mutate } = useDontManageGetDoc<RavenWorkspace>("Raven Workspace", ID)
...
const ViewWorkspaceContent = ({ data, mutate }: { data: RavenWorkspace, mutate: SWRResponse['mutate'] }) => {
    ...
    const { updateDoc, loading, error } = useDontManageUpdateDoc<RavenWorkspace>()
