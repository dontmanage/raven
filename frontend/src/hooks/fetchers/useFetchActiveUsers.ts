...
const useFetchActiveUsers = () => {
    const res = useDontManageGetCall<{ message: string[] }>('raven.api.user_availability.get_active_users',
        undefined,
        'active_users',
        {
...
export const useFetchActiveUsersRealtime = () => {
    ...
    useDontManageEventListener('raven:user_active_state_updated', (data) => {
