...
const useUnreadMessageCount = () => {
    ...
    const { data: unread_count, mutate: updateCount } = useDontManageGetCall<{ message: UnreadCountData }>("raven.api.raven_message.get_unread_count_for_channels",
        undefined,
    ...
    useDontManageEventListener('raven:unread_channel_count_updated', (event) => {
