...
def after_insert(doc, method):
	...
	department_channel = dontmanage.new_doc("Raven Channel")
...
def on_update(doc, method):
	linked_channels = dontmanage.get_all(
		"Raven Channel",
...
def on_trash(doc, method):
	dontmanage.db.delete("Raven Channel", {"linked_doctype": "Department", "linked_document": doc.name})


def get_auto_create_department_channel_type() -> str | None:
	raven_settings = dontmanage.get_single("Raven Settings")
