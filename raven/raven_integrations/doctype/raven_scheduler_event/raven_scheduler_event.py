...
class RavenSchedulerEvent(Document):
	...
	def before_save(self):
		...
		if not self.scheduler_event_id:
			...
			server_script = dontmanage.get_doc("Server Script", self.scheduler_event_id)
	...
	def on_trash(self):
		...
		"""
		if self.scheduler_event_id:
			dontmanage.db.delete("Server Script", self.scheduler_event_id)
	...
	def create_scheduler_event(self):
		...
		"""
		server_script = dontmanage.get_doc(
			{
	...
	def get_scheduler_event_script(self):
		...
		"""
		# bot = dontmanage.get_doc('Raven Bot', self.bot)
