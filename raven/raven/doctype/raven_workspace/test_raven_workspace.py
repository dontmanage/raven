...
class TestRavenWorkspace(IntegrationTestCase):
	...
	def test_delete_workspace(self):
		...
		self.assertRaises(dontmanage.DoesNotExistError, dontmanage.get_doc, "Raven Channel", channel.name)
		self.assertRaises(
			dontmanage.DoesNotExistError, dontmanage.get_doc, "Raven Workspace Member", member.name
		)
