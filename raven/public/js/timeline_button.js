// Timeline button for DontManage
$(document).on('app_ready', function () {
  $.each(dontmanage.boot.user.can_read, function (i, doctype) {
              ...
              if (channels && channels.message && channels.message.length > 0) {
                ...
                let setup_attach = () => {
                  ...
                  $(`
                    ...
                    <p class='add-more-attachments'>
                      <button class='btn btn-xs btn-default'>
                        ${dontmanage.utils.icon('small-add', 'xs')}&nbsp;
                        ${__('Add Attachment')}
                      </button>
                    </p>
                  ...
                  attach
                    ...
                    .on('click', () => new dontmanage.ui.FileUploader(args));
                  render_attachment_rows();
                };
                    ...
                    if (files.length) {
                      $.each(files, (i, f) => {
                        ...
                        if (
                          ...
                          f.file_url = dontmanage.urllib.get_full_url(f.file_url);
                  ...
                  return $(`
                    <p class="flex">
                      ...
                      <a href="${attachment.file_url
                        ...
                        ${dontmanage.utils.icon('link-url')}
                      </a>
                    </p>`);
                };
                ...
                let dialog;
                if (!dialog) {
                  dialog = new dontmanage.ui.Dialog({
            ...
            let send_message = (values, channel_id, attachments) => {
              ...
              dontmanage.db
                ...
                .then(() => {
                  ...
                  dontmanage.utils.play_sound('email');
                })
                .catch((err) => {
                  dontmanage.throw(__('Error sending message'));
                });
            };
