...
const MessageItem = ({ message }) => {
    ...
    const isOwner = dontmanage.session.user === userID
...
const MessageHeader = ({ message, user }) => {
    ...
    return <div className='raven-message-item-header'>
        ...
        <span className='raven-message-item-header-time'>{moment(message.creation, dontmanage.defaultDatetimeFormat).format('HH:mm A')}</span>
    </div>
}
